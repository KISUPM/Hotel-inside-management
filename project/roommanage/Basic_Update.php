...
if ($Dno != '') {
  ...
  $query = "SELECT * FROM room_description Where Dno = '" . $Dno . "'";
    ...
    <body>
      ...
      <div class="container-fluid text-center">
        <div class="row content">
          ...
          <form method="post" id="form" enctype="multipart/form-data" action="UI_UP_Basic.php">
            <label for="Price">Price:</label>
            <input type="number" name="Price" size="4" value="<?php echo $row['Price']; ?>"><br>

            <label for="Room_cap">Room_cap:</label>
            <input type="number" name="Room_cap" size="4" value="<?php echo $row['Room_cap']; ?>"><br>

            <label for="Bed_type">Room_cap:</label>
            <input type="text" name="Bed_type" size="4" value="<?php echo isset($row['Bed_type']); ?>"><br>

            <label for="Bathroom">Bathroom:</label>
            <input type="text" name="Bathroom" size="4" value="<?php echo isset($row['Bathroom']); ?>"><br>

            <label for="Fridge">Fridge:</label>
            <input type="text" name="Fridge" size="4" value="<?php echo isset($row['Fridge']); ?>"><br>

            <label for="TV">TV:</label>
            <input type="text" name="TV" size="4" value="<?php echo isset($row['TV']); ?>"><br>

            <label for="Ventilation">Ventilation:</label>
            <input type="text" name="Ventilation" size="4" value="<?php echo isset($row['Ventilation']); ?>"><br>
